...
| The :ref:`usage of the GUI <gui-quickstart>` provides the opportunity to explore and visualize data in a straightforward manner,
  without demanding any interaction with the code. The GUI offers the majority of data analysis options currently available in the
  ``mspypeline``.
...
MaxQuant Report
***********************
| A quality control report for combining information from output tables of MaxQuant. See :meth:`~mspypeline.MaxQuantPlotter.create_report`
